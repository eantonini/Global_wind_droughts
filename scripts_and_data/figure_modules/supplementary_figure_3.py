...
Description:
    ...
    This is Supplementary Figure 3 of the paper.
'''
...
def plot_supplementary_figure_3(wind_resource, histogram_of_seasonal_variability, histogram_of_weather_variability, median_of_seasonal_variability, median_of_weather_variability):
    '''
    ...
    title = '/Supplementary Figure 3a - Histogram of wind resource and seasonal variability'
    ...
    title = '/Supplementary Figure 3b - Histogram of wind resource and weather variability'
    fig.savefig(settings.figures_directory + title+'.png', bbox_inches = 'tight', dpi = 300)
