...
def plot_figure_4(lons_grid, lats_grid, regression_of_wind_power_density, regression_of_weather_variability, regression_of_wind_droughts):
    ...
    variables_to_plot = [regression_of_wind_power_density['slope']*100,
                         regression_of_weather_variability['slope']*100,
                         regression_of_wind_droughts['slope']*100]
    p_value_of_variables_to_plot = [regression_of_wind_power_density['p_value'].copy()*100,
                                    regression_of_weather_variability['p_value'].copy()*100,
                                    regression_of_wind_droughts['p_value'].copy()*100]
