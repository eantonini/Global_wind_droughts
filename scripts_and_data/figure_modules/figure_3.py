...
def plot_figure_3(lons_grid, lats_grid, geographic_masks, continent_masks, wind_resource, drought_extension):
    ...
    ax.annotate('Distribution across years\nof the fraction of land affected\nby the most severe wind droughts',
                xy=(0.05, 0.90), xycoords='axes fraction', horizontalalignment='left', verticalalignment='center', weight='bold', fontsize=20)
    ax.add_patch(Rectangle((0.6, 1973), 0.1/max_drought_extension, 1, facecolor='k', fill=True))
    ax.annotate('10% of area in region with power density ≥ 150 W m$^{-2}$',
                xy=(0.115, 0.049), xycoords='axes fraction', horizontalalignment='left', verticalalignment='center', weight='bold', fontsize=20)
