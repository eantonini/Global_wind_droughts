...
Description:
    ...
    This is Supplementary Figure 11 of the paper.
'''
...
def plot_supplementary_figure_11():
    '''
    ...
    titles = ['/Supplementary Figure 11b - Source from individual year capacity factor time series',
              '/Supplementary Figure 11a - Source from climatological capacity factor time series',
              '/Supplementary Figure 11d - Generation time series from individual year capacity factor',
              '/Supplementary Figure 11c - Generation time series from climatological capacity factor',
              '/Supplementary Figure 11e - Demand time series of constant value',
              '/Supplementary Figure 11f - Demand time series from climatological capacity factor']
